...
class JobHistoriesControllerTest < ActionController::TestCase
  ...
  test "should create job_history" do
    assert_difference('JobHistory.count') do
      post :create, job_history: { candidate_id: @job_history.candidate_id, employmentdate: @job_history.employmentdate, job: @job_history.job, salary: @job_history.salary }
    end
  ...
  test "should update job_history" do
    patch :update, id: @job_history, job_history: { candidate_id: @job_history.candidate_id, employmentdate: @job_history.employmentdate, job: @job_history.job, salary: @job_history.salary }
    assert_redirected_to job_history_path(assigns(:job_history))
  end
